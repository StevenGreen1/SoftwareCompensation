...
Calibration_Text += 'Scintillator_Thickness_Ring                        : ' + str(Scintillator_Thickness_Ring) + ' /mm \n'
Calibration_Text += 'Absorber_Thickness_EndCap                          : ' + str(Absorber_Thickness_EndCap) + ' /mm \n'
Calibration_Text += 'Scintillator_Thickness_EndCap                      : ' + str(Scintillator_Thickness_EndCap) + ' /mm \n\n'

ratio = (Absorber_Thickness_EndCap*Scintillator_Thickness_Ring)/(Absorber_Thickness_Ring*Scintillator_Thickness_EndCap)
