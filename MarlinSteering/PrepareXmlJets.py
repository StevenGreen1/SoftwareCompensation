...
if allFiles:
    ...
    for nfiles in range (array_size):
        ...
        if matchObj:
            ...
            newFileName = 'Marlin_ILD_o1_v06_Zuds_' + str(energy) + 'GeV_' + str(junk) + '.xml'
            marlinFullPath = os.path.join(marlinPath, newFileName)
            rootFileFullPath = os.path.join(rootFilePath, 'PFOAnalysis_PandoraSettingsDefault_ILD_o1_v06_Zuds_' + str(energy) + 'GeV_' + str(junk) + '.root')
            ...
            rootFileFullPathCellEnergyAlgorithm = os.path.join(rootFilePath, 'CellEnergyAlgorithm_PandoraSettingsDefault_ILD_o1_v06_Zuds_' + str(energy) + 'GeV_' + str(junk) + '.root')
            ...
            pandoraSettingsFile = os.getcwd() + '/../PandoraSettings/PandoraSettingsDefault_Zuds_' + str(energy) + 'GeV_' + str(junk) + '.xml'
...
file = open(runFilePath + '/MarlinRunFileJets.txt','w')
file.write(jobList)
file.close()
